    ...
    <main className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <section className="flex-grow flex items-center justify-center text-center p-8">
        <div className="max-w-xl">
          <h1 className="text-4xl font-bold mb-4">🎂 Birthday Link Policies & Legal</h1>
          <p className="text-lg text-gray-700 mb-6">
            Review our terms of service, privacy policy, and event guidelines.
            Birthday Link is committed to creating safe, premium, and unforgettable celebrations for all.
          </p>
          <Link
            href="/"
